        ...
        child: ListView(
          ...
          children: [
            ...
            CourseHorizontalList(courses: [
              Course(
                  "Arabic for Beginners", "Layla Hassan", "assets/arabic.png"),
            ...
            const SizedBox(height: 8),
            CourseHorizontalList(courses: [
              Course("Introduction to Cybersecurity", "Rami Al-Khalid",
            ...
            const SizedBox(height: 8),
            CourseHorizontalList(courses: [
              Course("Project Management", "Nadia Al-Sayed",
                  "assets/project_mgmt.png"),
              Course("Graphic Design Principles", "Marco Bianchi",
                  "assets/graphic_design.png"),
              Course(
                  "French Conversation", "Camille Dubois", "assets/french.png"),
            ]),
          ],
        ),
      ),
